...
public class ClassCreator {
    ...
    public static ClassCreator of(Module module) {
     ...
     * @return 创建器
     */
    public ClassCreator importClass(String className) {
     ...
     * @return 创建器
     */
    public ClassCreator importClassIf(String className, Supplier<Boolean> supplier) {
        if (supplier.get()) {
     ...
     * @return 创建器
     */
    public ClassCreator importClassIf(Supplier<String> nameSupplier, Supplier<Boolean> supplier) {
        if (supplier.get()) {
     ...
     * @return 创建器
     */
    public ClassCreator importClass(PsiClass psiClass) {
        if (null == psiClass) {
            return this;
        }
    ...
    public ClassCreator importClass(List<String> list) {
        if (CollectionUtils.isNotEmpty(list)) {
            list.forEach(this::importClass);
        }
        return this;
    }
     ...
     */
    public And addTo(PsiDirectory psiDirectory) {
     ...
     * @return 创建器
     */
    public ClassCreator addGetterAndSetterMethods() {
    ...
    public ClassCreator copyFields(PsiClass srcClass) {
        return this.copyFields(srcClass, new ArrayList<>(0));
    }

    public ClassCreator copyFields(PsiClass srcClass, String...disposedFields) {
     ...
     * @return 创建器
     */
    public ClassCreator copyFields(PsiClass srcClass, List<String> disposedFields) {
        PsiClass aClass = javaFile.getClasses()[0];
...
//            psiUtils.addGetterAndSetterMethods(aClass);
    ...
    public ClassCreator copyFields(String like) {
        if (StringUtils.isNotBlank(like)) {
            psiUtils.findClass(like).ifPresent(this::copyFields);
        }
        return this;
    }
